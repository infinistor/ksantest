...
namespace s3tests
{
	public class Replication : TestBase
	{
		...
		[Fact(DisplayName = "test_replication_invalid_source_bucket_name")]
		[Trait(MainData.Major, "Replication")]
		...
		[Fact(DisplayName = "test_replication_invalid_source_bucket_versioning")]
		[Trait(MainData.Major, "Replication")]
		[Trait(MainData.Minor, "ERROR")]
		...
		[Fact(DisplayName = "test_replication_invalid_target_bucket_name")]
		[Trait(MainData.Major, "Replication")]
		[Trait(MainData.Minor, "ERROR")]
		...
		[Fact(DisplayName = "test_replication_invalid_target_bucket_versioning")]
		[Trait(MainData.Major, "Replication")]
		[Trait(MainData.Minor, "ERROR")]
