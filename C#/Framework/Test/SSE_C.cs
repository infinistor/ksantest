...
namespace s3tests2
{
    ...
    public class SSE_C : TestBase
    {
        ...
        public void test_encryption_sse_c_other_key()
        {
            ...
            Client.PutObject(BucketName, Key: Key, Body: Data, SSEC:SSEC_A);

            var e = Assert.ThrowsException<AmazonS3Exception>(() => Client.GetObject(BucketName, Key, SSEC:SSEC_B));
            var StatusCode = e.StatusCode;
        ...
        public void test_encryption_sse_c_invalid_md5()
        {
            ...
            var e = Assert.ThrowsException<AmazonS3Exception>(() => Client.PutObject(BucketName, Key: Key, Body: Data, SSEC:SSEC));
        ...
        public void test_encryption_sse_c_multipart_bad_download()
        {
            ...
            var e = Assert.ThrowsException<AmazonS3Exception>(() => Client.GetObject(BucketName, Key, SSEC:GetSSEC));
            var StatusCode = e.StatusCode;
            Assert.AreEqual(HttpStatusCode.Forbidden, StatusCode);
