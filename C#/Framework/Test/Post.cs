...
namespace s3tests2
{
	...
	public class Post : TestBase
	{
		...
		[TestMethod("test_put_object_v4")]
		[TestProperty(MainData.Major, "Post")]
		[TestProperty(MainData.Minor, "signV4")]
		[TestProperty(MainData.Explanation, "[SignatureVersion4] post 방식으로 오브젝트 업로드 성공 확인")]
		[TestProperty(MainData.Result, MainData.ResultSuccess)]
		...
		[TestMethod("test_put_object_chunked_v4")]
		[TestProperty(MainData.Major, "Post")]
		[TestProperty(MainData.Minor, "signV4")]
		[TestProperty(MainData.Explanation, "[SignatureVersion4] post 방식으로 오브젝트 업로드 성공 확인")]
		[TestProperty(MainData.Result, MainData.ResultSuccess)]
		...
		[TestMethod("test_get_object_v4")]
		[TestProperty(MainData.Major, "Post")]
		[TestProperty(MainData.Minor, "signV4")]
		[TestProperty(MainData.Explanation, "[SignatureVersion4] post 방식으로 오브젝트 다운로드 성공 확인")]
		[TestProperty(MainData.Result, MainData.ResultSuccess)]
