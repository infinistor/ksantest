...
namespace s3tests2
{
	...
	public class ListObjectsV2 : TestBase
	{
		...
		public void test_bucket_listv2_delimiter_prefix()
		{
			...
			ContinuationToken = ValidateListObjectV2(BucketName, prefix, Delimiter, null, 1, true, new List<string>() { "asdf" }, new List<string>());
			ContinuationToken = ValidateListObjectV2(BucketName, prefix, Delimiter, ContinuationToken, 1, true, EmptyList, new List<string>() { "boo/" });
			ContinuationToken = ValidateListObjectV2(BucketName, prefix, Delimiter, ContinuationToken, 1, false, EmptyList, new List<string>() { "cquux/" }, true);

			ContinuationToken = ValidateListObjectV2(BucketName, prefix, Delimiter, null, 2, true, new List<string>() { "asdf" }, new List<string>() { "boo/" });
			ContinuationToken = ValidateListObjectV2(BucketName, prefix, Delimiter, ContinuationToken, 2, false, EmptyList, new List<string>() { "cquux/" }, true);

			prefix = "boo/";

			ContinuationToken = ValidateListObjectV2(BucketName, prefix, Delimiter, null, 1, true, new List<string>() { "boo/bar" }, new List<string>());
			ContinuationToken = ValidateListObjectV2(BucketName, prefix, Delimiter, ContinuationToken, 1, false, EmptyList, new List<string>() { "boo/baz/" }, true);

			ContinuationToken = ValidateListObjectV2(BucketName, prefix, Delimiter, null, 2, false, new List<string>() { "boo/bar" }, new List<string>() { "boo/baz/" }, true);
		}
		...
		public void test_bucket_listv2_delimiter_prefix_ends_with_delimiter()
		{
			...
			ValidateListObjectV2(BucketName, "asdf/", "/", null, 1000, false, new List<string>() { "asdf/" }, EmptyList, true);
		}
		...
		public void test_bucket_listv2_delimiter_prefix_underscore()
		{
			...
			ContinuationToken = ValidateListObjectV2(BucketName, prefix, delim, null, 1, true, new List<string>() { "_obj1_" }, new List<string>());
			ContinuationToken = ValidateListObjectV2(BucketName, prefix, delim, ContinuationToken, 1, true, EmptyList, new List<string>() { "_under1/" });
			ContinuationToken = ValidateListObjectV2(BucketName, prefix, delim, ContinuationToken, 1, false, EmptyList, new List<string>() { "_under2/" }, true);

			ContinuationToken = ValidateListObjectV2(BucketName, prefix, delim, null, 2, true, new List<string>() { "_obj1_" }, new List<string>() { "_under1/" });
			ContinuationToken = ValidateListObjectV2(BucketName, prefix, delim, ContinuationToken, 2, false, EmptyList, new List<string>() { "_under2/" }, true);

			prefix = "_under1/";

			ContinuationToken = ValidateListObjectV2(BucketName, prefix, delim, null, 1, true, new List<string>() { "_under1/bar" }, new List<string>());
			ContinuationToken = ValidateListObjectV2(BucketName, prefix, delim, ContinuationToken, 1, false, EmptyList, new List<string>() { "_under1/baz/" }, true);

			ContinuationToken = ValidateListObjectV2(BucketName, prefix, delim, null, 2, false, new List<string>() { "_under1/bar" }, new List<string>() { "_under1/baz/" }, true);
		}
