...
def setup():
    ...
    #config.default_endpoint = None	 # for awstests.conf(amazon)
    config.default_endpoint = "%s://%s:%d" % (proto, config.default_host, config.default_port)		# for s3test test(226 server)
