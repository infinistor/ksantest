...
def _bucket_is_empty(bucket):
    ...
    for obj in bucket.objects.all():
        ...
        break
    return is_empty
def _create_objects(bucket_name=None, keys=[]):
    """
...
class DeleteObjects(unittest.TestCase):
    @attr(major='DeleteObjects')
    @attr(minor='ListObjects')
    ...
    def test_multi_object_delete(self):
        print(inspect.getsource(DeleteObjects.test_multi_object_delete))
    ...
    def test_multi_objectv2_delete(self):
        print(inspect.getsource(DeleteObjects.test_multi_objectv2_delete))
        key_names = ['key0', 'key1', 'key2']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
...
class GetObject(unittest.TestCase):
    @attr(major='GetObject')
    @attr(minor='ERROR')
    @attr(resource='object')
    @attr(method='get')
    ...
    def test_object_read_not_exist(self):
        print(inspect.getsource(GetObject.test_get_object_ifunmodifiedsince_failed))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    #    print(inspect.getsource(GetObject.test_object_requestid_matches_header_on_error))
    #    bucket_name = get_new_bucket()
    #    client = get_client()
    ...
    def test_ranged_request_response_code(self):
        print(inspect.getsource(GetObject.test_ranged_request_response_code))
        content = 'testcontent'
    ...
    def test_ranged_request_return_trailing_bytes_response_code(self):
        print(inspect.getsource(GetObject.test_ranged_request_return_trailing_bytes_response_code))
        content = 'testcontent'
    ...
    def test_ranged_request_invalid_range(self):
        print(inspect.getsource(GetObject.test_ranged_request_invalid_range))
        content = 'testcontent'
    ...
    def test_ranged_request_empty_object(self):
        print(inspect.getsource(GetObject.test_ranged_request_empty_object))
        content = ''
...
class ListObjects(unittest.TestCase):
    ...
    def test_bucket_list_many(self):
        print(inspect.getsource(ListObjects.test_bucket_list_many))
    ...
    @attr(major='ListObjects')
    @attr(minor='Delimiter and Prefix')
    @attr(resource='bucket')
    @attr(method='get')
    @attr(operation='list')
    @attr(assertion='prefixes in multi-component object names')
    def test_bucket_list_delimiter_prefix(self):
        print(inspect.getsource(ListObjects.test_bucket_list_delimiter_prefix))
    ...
    def test_bucket_list_delimiter_prefix_underscore(self):
        print(inspect.getsource(ListObjects.test_bucket_list_delimiter_prefix_underscore))
    ...
    def test_bucket_list_delimiter_unreadable(self):
        print(inspect.getsource(ListObjects.test_bucket_list_delimiter_unreadable))
    ...
    def test_bucket_list_delimiter_empty(self):
        print(inspect.getsource(ListObjects.test_bucket_list_delimiter_empty))
        key_names = ['bar', 'baz', 'cab', 'foo']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_delimiter_none(self):
        print(inspect.getsource(ListObjects.test_bucket_list_delimiter_none))
        key_names = ['bar', 'baz', 'cab', 'foo']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_delimiter_not_exist(self):
        print(inspect.getsource(ListObjects.test_bucket_list_delimiter_not_exist))
        key_names = ['bar', 'baz', 'cab', 'foo']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_delimiter_not_skip_special(self):
        print(inspect.getsource(ListObjects.test_bucket_list_delimiter_not_skip_special))
    ...
    def test_bucket_list_prefix_basic(self):
        print(inspect.getsource(ListObjects.test_bucket_list_prefix_basic))
    ...
    def test_bucket_list_prefix_alt(self):
        print(inspect.getsource(ListObjects.test_bucket_list_prefix_alt))
    ...
    def test_bucket_list_prefix_empty(self):
        print(inspect.getsource(ListObjects.test_bucket_list_prefix_empty))
        key_names = ['foo/bar', 'foo/baz', 'quux']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_prefix_none(self):
        print(inspect.getsource(ListObjects.test_bucket_list_prefix_none))
        key_names = ['foo/bar', 'foo/baz', 'quux']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_prefix_not_exist(self):
        print(inspect.getsource(ListObjects.test_bucket_list_prefix_not_exist))
        key_names = ['foo/bar', 'foo/baz', 'quux']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_prefix_unreadable(self):
        print(inspect.getsource(ListObjects.test_bucket_list_prefix_unreadable))
        key_names = ['foo/bar', 'foo/baz', 'quux']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    @attr(major='ListObjects')
    @attr(minor='Prefix and Delimiter')
    @attr(resource='bucket')
    @attr(method='get')
    ...
    def test_bucket_list_prefix_delimiter_basic(self):
        print(inspect.getsource(ListObjects.test_bucket_list_prefix_delimiter_basic))
    ...
    def test_bucket_list_maxkeys_one(self):
        print(inspect.getsource(ListObjects.test_bucket_list_maxkeys_one))
    ...
    def test_bucket_list_maxkeys_zero(self):
        print(inspect.getsource(ListObjects.test_bucket_list_maxkeys_zero))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_maxkeys_none(self):
        print(inspect.getsource(ListObjects.test_bucket_list_maxkeys_none))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_maxkeys_invalid(self):
        print(inspect.getsource(ListObjects.test_bucket_list_maxkeys_invalid))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_marker_none(self):
        print(inspect.getsource(ListObjects.test_bucket_list_marker_none))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_marker_empty(self):
        print(inspect.getsource(ListObjects.test_bucket_list_marker_empty))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_marker_unreadable(self):
        print(inspect.getsource(ListObjects.test_bucket_list_marker_unreadable))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_marker_not_in_list(self):
        print(inspect.getsource(ListObjects.test_bucket_list_marker_not_in_list))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_marker_after_list(self):
        print(inspect.getsource(ListObjects.test_bucket_list_marker_after_list))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_return_data(self):
        print(inspect.getsource(ListObjects.test_bucket_list_return_data))
        key_names = ['bar', 'baz', 'foo']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_list_objects_anonymous(self):
        print(inspect.getsource(ListObjects.test_bucket_list_objects_anonymous))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_bucket_list_objects_anonymous_fail(self):
        print(inspect.getsource(ListObjects.test_bucket_list_objects_anonymous_fail))
        bucket_name = get_new_bucket()
    ...
    def test_bucket_notexist(self):
        print(inspect.getsource(ListObjects.test_bucket_notexist))
        bucket_name = get_new_bucket_name()
        client = get_client()
...
class ListObjectsV2(unittest.TestCase):
    @attr(major='ListObjectsV2')
    @attr(minor='Check')
    @attr(resource='bucket')
    @attr(method='get')
    @attr(operation='list all keys')
    ...
    def test_bucket_listv2_many(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_many))
        bucket_name = _create_objects(keys=['foo', 'bar', 'baz'])
        client = get_client()
    ...
    def test_basic_key_count(self):
        print(inspect.getsource(ListObjectsV2.test_basic_key_count))
        client = get_client()
        bucket_names = []
        bucket_name = get_new_bucket_name()
    ...
    def test_bucket_listv2_delimiter_basic(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_delimiter_basic))
        bucket_name = _create_objects(keys=['foo/bar', 'foo/bar/xyzzy', 'quux/thud', 'asdf'])
        client = get_client()
    ...
    def test_bucket_listv2_delimiter_prefix(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_delimiter_prefix))
        bucket_name = _create_objects(keys=['asdf', 'boo/bar', 'boo/baz/xyzzy', 'cquux/thud', 'cquux/bla'])
    ...
    def test_bucket_listv2_delimiter_prefix_underscore(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_delimiter_prefix_underscore))
        bucket_name = _create_objects(keys=['_obj1_','_under1/bar', '_under1/baz/xyzzy', '_under2/thud', '_under2/bla'])
    ...
    def test_bucket_listv2_delimiter_unreadable(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_delimiter_unreadable))
        key_names=['bar', 'baz', 'cab', 'foo']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_delimiter_empty(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_delimiter_empty))
        key_names = ['bar', 'baz', 'cab', 'foo']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_delimiter_none(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_delimiter_none))
        key_names = ['bar', 'baz', 'cab', 'foo']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    @attr(major='ListObjectsV2')
    @attr(minor='Fetchowner')
    @attr('list-objects-v2')
    def test_bucket_listv2_fetchowner_notempty(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_fetchowner_notempty))
        key_names = ['foo/bar', 'foo/baz', 'quux']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_fetchowner_defaultempty(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_fetchowner_defaultempty))
        key_names = ['foo/bar', 'foo/baz', 'quux']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_fetchowner_empty(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_fetchowner_empty))
        key_names = ['foo/bar', 'foo/baz', 'quux']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_delimiter_not_exist(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_delimiter_not_exist))
        key_names = ['bar', 'baz', 'cab', 'foo']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_prefix_basic(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_prefix_basic))
        key_names = ['foo/bar', 'foo/baz', 'quux']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_prefix_alt(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_prefix_alt))
        key_names = ['bar', 'baz', 'foo']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_prefix_empty(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_prefix_empty))
        key_names = ['foo/bar', 'foo/baz', 'quux']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_prefix_none(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_prefix_none))
        key_names = ['foo/bar', 'foo/baz', 'quux']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_prefix_not_exist(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_prefix_not_exist))
        key_names = ['foo/bar', 'foo/baz', 'quux']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_prefix_unreadable(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_prefix_unreadable))
        key_names = ['foo/bar', 'foo/baz', 'quux']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_prefix_delimiter_basic(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_prefix_delimiter_basic))
        key_names = ['foo/bar', 'foo/baz/xyzzy', 'quux/thud', 'asdf']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_maxkeys_one(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_maxkeys_one))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_maxkeys_zero(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_maxkeys_zero))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_maxkeys_none(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_maxkeys_none))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_objects_anonymous(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_objects_anonymous))
        bucket_name = get_new_bucket()
        client = get_client()
        client.put_bucket_acl(Bucket=bucket_name, ACL='public-read')
    ...
    def test_bucket_listv2_objects_anonymous_fail(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_objects_anonymous_fail))
        bucket_name = get_new_bucket()
    ...
    def test_bucketv2_notexist(self):
        print(inspect.getsource(ListObjectsV2.test_bucketv2_notexist))
        bucket_name = get_new_bucket_name()
        client = get_client()
    ...
    def test_bucket_listv2_continuationtoken(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_continuationtoken))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    @attr(major='ListObjectsV2')
    @attr(minor='Continuationtoken and StartAfter')
    @attr(resource='bucket')
    @attr(method='get')
    @attr(operation='list keys with list-objects-v2')
    ...
    def test_bucket_listv2_both_continuationtoken_startafter(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_both_continuationtoken_startafter))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_startafter_unreadable(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_startafter_unreadable))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_listv2_startafter_not_in_list(self):
        print(inspect.getsource(ListObjectsV2.test_bucket_listv2_startafter_not_in_list))
        key_names = ['bar', 'baz', 'foo', 'quxx']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
...
class ListObjectsVersions(unittest.TestCase):
    @attr(major='ListObjectsVersions')
    @attr(minor='Metadata')
    @attr(resource='object')
    @attr(method='head')
    ...
    def test_bucket_list_return_data_versioning(self):
        print(inspect.getsource(ListObjectsVersions.test_bucket_list_return_data_versioning))
        bucket_name = get_new_bucket()
...
class PutBucket(unittest.TestCase):
    @attr(major='PutBucket')
    @attr(minor='Put')
    @attr(resource='bucket')
    @attr(method='get')
    @attr(operation='list')
    ...
    def test_bucket_list_empty(self):
        print(inspect.getsource(PutBucket.test_bucket_list_empty))
        bucket = get_new_bucket_resource()
        is_empty = _bucket_is_empty(bucket)
        eq(is_empty, True)

    @attr(major='PutBucket')
    @attr(minor='Creation rules')
    @attr(resource='bucket')
    @attr(method='put')
    ...
    def test_bucket_create_naming_good_starts_alpha(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_good_starts_alpha))
    ...
    def test_bucket_create_naming_good_starts_digit(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_good_starts_digit))
    ...
    def test_bucket_create_naming_good_contains_period(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_good_contains_period))
    ...
    def test_bucket_create_naming_good_contains_hyphen(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_good_contains_hyphen))
        check_good_bucket_name('aaa-111')
    ...
    def test_bucket_create_naming_bad_starts_nonalpha(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_bad_starts_nonalpha))
        bucket_name = get_new_bucket_name()
    ...
    def test_bucket_create_naming_bad_short_one(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_bad_short_one))
    ...
    def test_bucket_create_naming_bad_short_two(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_bad_short_two))
    ...
    def test_bucket_create_naming_good_long_60(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_good_long_60))
    ...
    def test_bucket_create_naming_good_long_61(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_good_long_61))
    ...
    def test_bucket_create_naming_good_long_62(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_good_long_62))
    ...
    def test_bucket_create_naming_good_long_63(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_good_long_63))
    ...
    def test_bucket_list_long_name(self):
        print(inspect.getsource(PutBucket.test_bucket_list_long_name))
        prefix = get_new_bucket_name()
        length = 61
        num = length - len(prefix)
        name=num*'a'
    ...
    def test_bucket_create_naming_bad_ip(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_bad_ip))
    ...
    def test_bucket_create_naming_dns_underscore(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_dns_underscore))
    ...
    def test_bucket_create_naming_dns_long(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_dns_long))
        prefix = get_prefix()
    ...
    def test_bucket_create_naming_dns_dash_at_end(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_dns_dash_at_end))
    ...
    def test_bucket_create_naming_dns_dot_dot(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_dns_dot_dot))
    ...
    def test_bucket_create_naming_dns_dot_dash(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_dns_dot_dash))
        invalid_bucketname = 'foo.-bar'
        status, error_code = check_invalid_bucketname(invalid_bucketname)
        eq(status, 400)
        eq(error_code, 'InvalidBucketName')
    ...
    def test_bucket_create_naming_dns_dash_dot(self):
        print(inspect.getsource(PutBucket.test_bucket_create_naming_dns_dash_dot))
        invalid_bucketname = 'foo-.bar'
        status, error_code = check_invalid_bucketname(invalid_bucketname)
        eq(status, 400)
        eq(error_code, 'InvalidBucketName')
    ...
    @attr(major='PutBucket')
    @attr(minor='Duplicate')
    @attr(resource='bucket')
    @attr(method='put')
    @attr(operation='re-create')
    def test_bucket_create_exists(self):
        print(inspect.getsource(PutBucket.test_bucket_create_exists))
    ...
    def test_bucket_create_exists_nonowner(self):
        print(inspect.getsource(PutBucket.test_bucket_create_exists_nonowner))
    ...
    def test_bucket_recreate_not_overriding(self):
        print(inspect.getsource(PutObject.test_bucket_recreate_not_overriding))
...
class PutObject(unittest.TestCase):
    @attr(major='PutObject')
    @attr(minor='Special Key Name')
    @attr(resource='object')
    @attr(method='put')
    ...
    def test_bucket_create_special_key_names(self):
        print(inspect.getsource(PutObject.test_bucket_create_special_key_names))
        key_names = [
            ' ',
            '"',
            '$',
    ...
    def test_bucket_list_special_prefix(self):
        print(inspect.getsource(PutObject.test_bucket_list_special_prefix))
    ...
    def test_bucket_list_distinct(self):
        print(inspect.getsource(PutObject.test_bucket_list_distinct))
    ...
    def test_object_write_to_nonexist_bucket(self):
        print(inspect.getsource(PutObject.test_object_write_to_nonexist_bucket))
        key_names = ['foo']
    ...
    def test_object_head_zero_bytes(self):
        print(inspect.getsource(PutObject.test_object_head_zero_bytes))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_write_check_etag(self):
        print(inspect.getsource(PutObject.test_object_write_check_etag))
        bucket_name = get_new_bucket()
        client = get_client()
        response = client.put_object(Bucket=bucket_name, Key='foo', Body='bar')
        eq(response['ResponseMetadata']['HTTPStatusCode'], 200)
    ...
    @attr(major='PutObject')
    @attr(minor='Cache control')
    @attr(resource='object')
    @attr(method='put')
    @attr(operation='write key')
    @attr(assertion='correct cache control header')
    def test_object_write_cache_control(self):
        print(inspect.getsource(PutObject.test_object_write_cache_control))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_write_expires(self):
        print(inspect.getsource(PutObject.test_object_write_expires))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_write_read_update_read_delete(self):
        print(inspect.getsource(PutObject.test_object_write_read_update_read_delete))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_set_get_metadata_none_to_good(self):
        print(inspect.getsource(PutObject.test_object_set_get_metadata_none_to_good))
    ...
    def test_object_set_get_metadata_none_to_empty(self):
        print(inspect.getsource(PutObject.test_object_set_get_metadata_none_to_empty))
    ...
    def test_object_set_get_non_utf8_metadata(self):
        print(inspect.getsource(PutObject.test_object_set_get_non_utf8_metadata))
        metadata = '\x04mymeta'
    ...
    def test_object_set_get_metadata_overwrite_to_empty(self):
        print(inspect.getsource(PutObject.test_object_set_get_metadata_overwrite_to_empty))
        bucket_name = get_new_bucket()
    ...
    def test_object_set_get_metadata_empty_to_unreadable_prefix(self):
        print(inspect.getsource(PutObject.test_object_set_get_metadata_empty_to_unreadable_prefix))
        metadata = '\x04w'
        e = _set_get_metadata_unreadable(metadata)
        status, error_code = _get_status_and_error_code(e.response)
        eq(status, 400 or 403)
    ...
    def test_object_set_get_metadata_empty_to_unreadable_suffix(self):
        print(inspect.getsource(PutObject.test_object_set_get_metadata_empty_to_unreadable_suffix))
        metadata = 'h\x04'
        e = _set_get_metadata_unreadable(metadata)
        status, error_code = _get_status_and_error_code(e.response)
        eq(status, 400 or 403)
    ...
    def test_object_metadata_replaced_on_put(self):
        print(inspect.getsource(PutObject.test_object_metadata_replaced_on_put))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_write_file(self):
        print(inspect.getsource(PutObject.test_object_write_file))
        bucket_name = get_new_bucket()
        client = get_client()
        data_str = 'bar'
        data = bytes(data_str, 'utf-8')
    ...
    def test_object_lock_uploading_obj(self):
        print(inspect.getsource(PutObject.test_object_lock_uploading_obj))
        bucket_name = get_new_bucket_name()
        client = get_client()
...
class ACL(unittest.TestCase):
    ...
    def test_object_raw_get(self):
        print(inspect.getsource(ACL.test_object_raw_get))
    ...
    def test_object_raw_get_bucket_gone(self):
        print(inspect.getsource(ACL.test_object_raw_get_bucket_gone))
        bucket_name = _setup_bucket_object_acl('public-read', 'public-read')
        client = get_client()
    ...
    def test_object_delete_key_bucket_gone(self):
        print(inspect.getsource(ACL.test_object_delete_key_bucket_gone))
        bucket_name = _setup_bucket_object_acl('public-read', 'public-read')
        client = get_client()
    ...
    def test_object_raw_get_object_gone(self):
        print(inspect.getsource(ACL.test_object_raw_get_object_gone))
        bucket_name = _setup_bucket_object_acl('public-read', 'public-read')
        client = get_client()
    ...
    def test_object_raw_get_bucket_acl(self):
        print(inspect.getsource(ACL.test_object_raw_get_bucket_acl))
    ...
    def test_object_raw_get_object_acl(self):
        print(inspect.getsource(ACL.test_object_raw_get_object_acl))
    ...
    def test_object_raw_authenticated(self):
        print(inspect.getsource(ACL.test_object_raw_authenticated))
        bucket_name = _setup_bucket_object_acl('public-read', 'public-read')
    ...
    def test_object_raw_response_headers(self):
        print(inspect.getsource(ACL.test_object_raw_response_headers))
    ...
    def test_object_raw_authenticated_bucket_acl(self):
        print(inspect.getsource(ACL.test_object_raw_authenticated_bucket_acl))
        bucket_name = _setup_bucket_object_acl('private', 'public-read')
    ...
    def test_object_raw_authenticated_object_acl(self):
        print(inspect.getsource(ACL.test_object_raw_authenticated_object_acl))
        bucket_name = _setup_bucket_object_acl('public-read', 'private')
    ...
    def test_object_raw_authenticated_bucket_gone(self):
        print(inspect.getsource(ACL.test_object_raw_authenticated_bucket_gone))
        bucket_name = _setup_bucket_object_acl('public-read', 'public-read')
        client = get_client()
    ...
    def test_object_raw_authenticated_object_gone(self):
        print(inspect.getsource(ACL.test_object_raw_authenticated_object_gone))
        bucket_name = _setup_bucket_object_acl('public-read', 'public-read')
        client = get_client()
    ...
    def test_object_raw_get_x_amz_expires_not_expired(self):
        print(inspect.getsource(ACL.test_object_raw_get_x_amz_expires_not_expired))
        bucket_name = _setup_bucket_object_acl('public-read', 'public-read')
        client = get_client()
    ...
    def test_object_raw_get_x_amz_expires_out_range_zero(self):
        print(inspect.getsource(ACL.test_object_raw_get_x_amz_expires_out_range_zero))
        bucket_name = _setup_bucket_object_acl('public-read', 'public-read')
        client = get_client()
        params = {'Bucket': bucket_name, 'Key': 'foo'}
    ...
    def test_object_raw_get_x_amz_expires_out_positive_range(self):
        print(inspect.getsource(ACL.test_object_raw_get_x_amz_expires_out_positive_range))
        bucket_name = _setup_bucket_object_acl('public-read', 'public-read')
        client = get_client()
        params = {'Bucket': bucket_name, 'Key': 'foo'}
    ...
    def test_object_anon_put(self):
        print(inspect.getsource(ACL.test_object_anon_put))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_anon_put_write_access(self):
        print(inspect.getsource(ACL.test_object_anon_put_write_access))
    ...
    def test_object_put_authenticated(self):
        print(inspect.getsource(ACL.test_object_put_authenticated))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_raw_put_authenticated_expired(self):
        print(inspect.getsource(ACL.test_object_raw_put_authenticated_expired))
        bucket_name = get_new_bucket()
        client = get_client()
        client.put_object(Bucket=bucket_name, Key='foo')
...
class DeleteBucket(unittest.TestCase):
    @attr(major='DeleteBucket')
    @attr(minor='ERROR')
    @attr(resource='bucket')
    @attr(method='delete')
    @attr(operation='non-existant bucket')
    ...
    def test_bucket_delete_notexist(self):
        print(inspect.getsource(DeleteBucket.test_bucket_delete_notexist))
        bucket_name = get_new_bucket_name()
        client = get_client()
    ...
    def test_bucket_delete_nonempty(self):
        print(inspect.getsource(DeleteBucket.test_bucket_delete_nonempty))
        key_names = ['foo']
        bucket_name = _create_objects(keys=key_names)
        client = get_client()
    ...
    def test_bucket_create_delete(self):
        print(inspect.getsource(DeleteBucket.test_bucket_create_delete))
        bucket_name = get_new_bucket()
        client = get_client()
        client.delete_bucket(Bucket=bucket_name)
...
class Post(unittest.TestCase):
    ...
    def test_post_object_anonymous_request(self):
        print(inspect.getsource(Post.test_post_object_anonymous_request))
        bucket_name = get_new_bucket_name()
        client = get_client()
    ...
    def test_post_object_authenticated_request(self):
        print(inspect.getsource(Post.test_post_object_authenticated_request))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_authenticated_no_content_type(self):
        print(inspect.getsource(Post.test_post_object_authenticated_no_content_type))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(ACL='public-read-write', Bucket=bucket_name)
    ...
    def test_post_object_authenticated_request_bad_access_key(self):
        print(inspect.getsource(Post.test_post_object_authenticated_request_bad_access_key))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(ACL='public-read-write', Bucket=bucket_name)
    ...
    @attr(major='Post')
    @attr(minor='Status code')
    @attr(resource='object')
    @attr(method='post')
    @attr(operation='anonymous browser based upload via POST request')
    @attr(assertion='succeeds with status 201')
    def test_post_object_set_success_code(self):
        print(inspect.getsource(Post.test_post_object_set_success_code))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(ACL='public-read-write', Bucket=bucket_name)
    ...
    def test_post_object_set_invalid_success_code(self):
        print(inspect.getsource(Post.test_post_object_set_invalid_success_code))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(ACL='public-read-write', Bucket=bucket_name)
    ...
    def test_post_object_upload_larger_than_chunk(self):
        print(inspect.getsource(Post.test_post_object_upload_larger_than_chunk))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_set_key_from_filename(self):
        print(inspect.getsource(Post.test_post_object_set_key_from_filename))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_ignored_header(self):
        print(inspect.getsource(Post.test_post_object_ignored_header))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_case_insensitive_condition_fields(self):
        print(inspect.getsource(Post.test_post_object_case_insensitive_condition_fields))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_escaped_field_values(self):
        print(inspect.getsource(Post.test_post_object_escaped_field_values))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_success_redirect_action(self):
        print(inspect.getsource(Post.test_post_object_success_redirect_action))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(ACL='public-read-write', Bucket=bucket_name)
    ...
    def test_post_object_invalid_signature(self):
        print(inspect.getsource(Post.test_post_object_invalid_signature))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_invalid_access_key(self):
        print(inspect.getsource(Post.test_post_object_invalid_access_key))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_invalid_date_format(self):
        print(inspect.getsource(Post.test_post_object_invalid_date_format))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_no_key_specified(self):
        print(inspect.getsource(Post.test_post_object_no_key_specified))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_missing_signature(self):
        print(inspect.getsource(Post.test_post_object_missing_signature))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_missing_policy_condition(self):
        print(inspect.getsource(Post.test_post_object_missing_policy_condition))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_user_specified_header(self):
        print(inspect.getsource(Post.test_post_object_user_specified_header))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_request_missing_policy_specified_field(self):
        print(inspect.getsource(Post.test_post_object_request_missing_policy_specified_field))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_condition_is_case_sensitive(self):
        print(inspect.getsource(Post.test_post_object_condition_is_case_sensitive))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_expires_is_case_sensitive(self):
        print(inspect.getsource(Post.test_post_object_expires_is_case_sensitive))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_expired_policy(self):
        print(inspect.getsource(Post.test_post_object_expired_policy))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_invalid_request_field_value(self):
        print(inspect.getsource(Post.test_post_object_invalid_request_field_value))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_missing_expires_condition(self):
        print(inspect.getsource(Post.test_post_object_missing_expires_condition))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_missing_conditions_list(self):
        print(inspect.getsource(Post.test_post_object_missing_conditions_list))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_upload_size_limit_exceeded(self):
        print(inspect.getsource(Post.test_post_object_upload_size_limit_exceeded))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_missing_content_length_argument(self):
        print(inspect.getsource(Post.test_post_object_missing_content_length_argument))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_invalid_content_length_argument(self):
        print(inspect.getsource(Post.test_post_object_invalid_content_length_argument))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_upload_size_below_minimum(self):
        print(inspect.getsource(Post.test_post_object_upload_size_below_minimum))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_post_object_empty_conditions(self):
        print(inspect.getsource(Post.test_post_object_empty_conditions))
        bucket_name = get_new_bucket()
        client = get_client()
...
class Grants(unittest.TestCase):
    ...
    def test_bucket_acl_default(self):
        print(inspect.getsource(Grants.test_bucket_acl_default))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_bucket_acl_canned_during_create(self):
        print(inspect.getsource(Grants.test_bucket_acl_canned_during_create))
        bucket_name = get_new_bucket_name()
        client = get_client()
    ...
    def test_bucket_acl_canned(self):
        print(inspect.getsource(Grants.test_bucket_acl_canned))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(ACL='public-read', Bucket=bucket_name)
        response = client.get_bucket_acl(Bucket=bucket_name)
    ...
    def test_bucket_acl_canned_publicreadwrite(self):
        print(inspect.getsource(Grants.test_bucket_acl_canned_publicreadwrite))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(ACL='public-read-write', Bucket=bucket_name)
        response = client.get_bucket_acl(Bucket=bucket_name)
    ...
    def test_bucket_acl_canned_authenticatedread(self):
        print(inspect.getsource(Grants.test_bucket_acl_canned_authenticatedread))
        bucket_name = get_new_bucket_name()
        client = get_client()
    ...
    def test_object_acl_default(self):
        print(inspect.getsource(Grants.test_object_acl_default))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_acl_canned_during_create(self):
        print(inspect.getsource(Grants.test_object_acl_canned_during_create))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_acl_canned(self):
        print(inspect.getsource(Grants.test_object_acl_canned))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_acl_canned_publicreadwrite(self):
        print(inspect.getsource(Grants.test_object_acl_canned_publicreadwrite))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_acl_canned_authenticatedread(self):
        print(inspect.getsource(Grants.test_object_acl_canned_authenticatedread))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_acl_canned_bucketownerread(self):
        print(inspect.getsource(Grants.test_object_acl_canned_bucketownerread))
        bucket_name = get_new_bucket_name()
    ...
    def test_object_acl_canned_bucketownerfullcontrol(self):
        print(inspect.getsource(Grants.test_object_acl_canned_bucketownerfullcontrol))
        bucket_name = get_new_bucket_name()
        main_client = get_client()
        alt_client = get_alt_client()
    ...
    def test_object_acl_full_control_verify_owner(self):
        print(inspect.getsource(Grants.test_object_acl_full_control_verify_owner))
        bucket_name = get_new_bucket_name()
        main_client = get_client()
        alt_client = get_alt_client()
    ...
    def test_object_acl_full_control_verify_attributes(self):
        print(inspect.getsource(Grants.test_object_acl_full_control_verify_attributes))
        bucket_name = get_new_bucket_name()
        main_client = get_client()
        alt_client = get_alt_client()
    ...
    def test_object_acl(self):
        print(inspect.getsource(Grants.test_object_acl))
    ...
    def test_object_acl_write(self):
        print(inspect.getsource(Grants.test_object_acl_write))
    ...
    def test_object_acl_writeacp(self):
        print(inspect.getsource(Grants.test_object_acl_writeacp))
    ...
    def test_object_acl_read(self):
        print(inspect.getsource(Grants.test_object_acl_read))
    ...
    def test_object_acl_readacp(self):
        print(inspect.getsource(Grants.test_object_acl_readacp))
    ...
    def test_bucket_acl_grant_userid_fullcontrol(self):
        print(inspect.getsource(Grants.test_bucket_acl_grant_userid_fullcontrol))
    ...
    def test_bucket_acl_grant_userid_read(self):
        print(inspect.getsource(Grants.test_bucket_acl_grant_userid_read))
    ...
    def test_bucket_acl_grant_userid_readacp(self):
        print(inspect.getsource(Grants.test_bucket_acl_grant_userid_readacp))
    ...
    def test_bucket_acl_grant_userid_write(self):
        print(inspect.getsource(Grants.test_bucket_acl_grant_userid_write))
    ...
    def test_bucket_acl_grant_userid_writeacp(self):
        print(inspect.getsource(Grants.test_bucket_acl_grant_userid_writeacp))
    ...
    def test_bucket_acl_grant_nonexist_user(self):
        print(inspect.getsource(Grants.test_bucket_acl_grant_nonexist_user))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_bucket_acl_no_grants(self):
        print(inspect.getsource(Grants.test_bucket_acl_no_grants))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_header_acl_grants(self):
        print(inspect.getsource(Grants.test_object_header_acl_grants))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_bucket_header_acl_grants(self):
        print(inspect.getsource(Grants.test_bucket_header_acl_grants))
        headers = _get_acl_header()
        bucket_name = get_new_bucket_name()
        client = get_client()
    ...
    def test_bucket_acl_revoke_all(self):
        print(inspect.getsource(Grants.test_bucket_acl_revoke_all))
    ...
    def test_access_bucket_private_object_private(self):
        print(inspect.getsource(Grants.test_access_bucket_private_object_private))
    ...
    def test_access_bucket_private_objectv2_private(self):
        print(inspect.getsource(Grants.test_access_bucket_private_objectv2_private))
        # all the test_access_* tests follow this template
        bucket_name, key1, key2, newkey = _setup_access(bucket_acl='private', object_acl='private')
    ...
    def test_access_bucket_private_object_publicread(self):
        print(inspect.getsource(Grants.test_access_bucket_private_object_publicread))
    ...
    def test_access_bucket_private_objectv2_publicread(self):
        print(inspect.getsource(Grants.test_access_bucket_private_objectv2_publicread))
    ...
    def test_access_bucket_private_object_publicreadwrite(self):
        print(inspect.getsource(Grants.test_access_bucket_private_object_publicreadwrite))
    ...
    def test_access_bucket_private_objectv2_publicreadwrite(self):
        print(inspect.getsource(Grants.test_access_bucket_private_objectv2_publicreadwrite))
        bucket_name, key1, key2, newkey = _setup_access(bucket_acl='private', object_acl='public-read-write')
        alt_client = get_alt_client()
        response = alt_client.get_object(Bucket=bucket_name, Key=key1)
    ...
    def test_access_bucket_publicread_object_private(self):
        print(inspect.getsource(Grants.test_access_bucket_publicread_object_private))
    ...
    def test_access_bucket_publicread_object_publicread(self):
        print(inspect.getsource(Grants.test_access_bucket_publicread_object_publicread))
    ...
    def test_access_bucket_publicread_object_publicreadwrite(self):
        print(inspect.getsource(Grants.test_access_bucket_publicread_object_publicreadwrite))
    ...
    def test_access_bucket_publicreadwrite_object_private(self):
        print(inspect.getsource(Grants.test_access_bucket_publicreadwrite_object_private))
    ...
    def test_access_bucket_publicreadwrite_object_publicread(self):
        print(inspect.getsource(Grants.test_access_bucket_publicreadwrite_object_publicread))
    ...
    def test_access_bucket_publicreadwrite_object_publicreadwrite(self):
        print(inspect.getsource(Grants.test_access_bucket_publicreadwrite_object_publicreadwrite))
...
class ListBuckets(unittest.TestCase):
    @attr(major='ListBuckets')
    @attr(minor='Get')
    @attr(resource='bucket')
    @attr(method='get')
    ...
    def test_buckets_create_then_list(self):
        print(inspect.getsource(ListBuckets.test_buckets_create_then_list))
        client = get_client()
        bucket_names = []
        for i in range(5):
            bucket_name = get_new_bucket_name()
    ...
    def test_list_buckets_invalid_auth(self):
        print(inspect.getsource(ListBuckets.test_list_buckets_invalid_auth))
    ...
    def test_list_buckets_bad_auth(self):
        print(inspect.getsource(ListBuckets.test_list_buckets_bad_auth))
...
class CopyObject(unittest.TestCase):
    @attr(major='CopyObject')
    @attr(minor='Check')
    @attr(resource='object')
    @attr(method='put')
    ...
    def test_object_copy_zero_size(self):
        print(inspect.getsource(CopyObject.test_object_copy_zero_size))
        key = 'foo123bar'
    ...
    def test_object_copy_same_bucket(self):
        print(inspect.getsource(CopyObject.test_object_copy_same_bucket))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    @attr(major='CopyObject')
    @attr(minor='ContentType')
    @attr(resource='object')
    @attr(method='put')
    @attr(operation='copy object with content-type')
    @attr(assertion='works')
    def test_object_copy_verify_contenttype(self):
        print(inspect.getsource(CopyObject.test_object_copy_verify_contenttype))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    @attr(major='CopyObject')
    @attr(minor='OverWrite')
    @attr(resource='object')
    @attr(method='put')
    @attr(operation='copy object to itself')
    @attr(assertion='fails')
    def test_object_copy_to_itself(self):
        print(inspect.getsource(CopyObject.test_object_copy_to_itself))
        bucket_name = get_new_bucket()
        client = get_client()
        client.put_object(Bucket=bucket_name, Key='foo123bar', Body='foo')
    ...
    def test_object_copy_to_itself_with_metadata(self):
        print(inspect.getsource(CopyObject.test_object_copy_to_itself_with_metadata))
        bucket_name = get_new_bucket()
        client = get_client()
        client.put_object(Bucket=bucket_name, Key='foo123bar', Body='foo')
        copy_source = {'Bucket': bucket_name, 'Key': 'foo123bar'}
    ...
    def test_object_copy_diff_bucket(self):
        print(inspect.getsource(CopyObject.test_object_copy_diff_bucket))
    ...
    def test_object_copy_not_owned_bucket(self):
        print(inspect.getsource(CopyObject.test_object_copy_not_owned_bucket))
        client = get_client()
        alt_client = get_alt_client()
    ...
    def test_object_copy_not_owned_object_bucket(self):
        print(inspect.getsource(CopyObject.test_object_copy_not_owned_object_bucket))
        client = get_client()
        alt_client = get_alt_client()
        bucket_name = get_new_bucket_name()
        client.create_bucket(Bucket=bucket_name)
    ...
    def test_object_copy_canned_acl(self):
        print(inspect.getsource(CopyObject.test_object_copy_canned_acl))
        bucket_name = get_new_bucket()
        client = get_client()
        alt_client = get_alt_client()
        client.put_object(Bucket=bucket_name, Key='foo123bar', Body='foo')
    ...
    def test_object_copy_retaining_metadata(self):
        print(inspect.getsource(CopyObject.test_object_copy_retaining_metadata))
    ...
    def test_object_copy_replacing_metadata(self):
        print(inspect.getsource(CopyObject.test_object_copy_replacing_metadata))
        for size in [3, 1024 * 1024]:
            bucket_name = get_new_bucket()
            client = get_client()
            content_type = 'audio/ogg'
    ...
    def test_object_copy_bucket_not_found(self):
        print(inspect.getsource(CopyObject.test_object_copy_bucket_not_found))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_copy_key_not_found(self):
        print(inspect.getsource(CopyObject.test_object_copy_key_not_found))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_object_copy_versioned_bucket(self):
        print(inspect.getsource(CopyObject.test_object_copy_versioned_bucket))
        bucket_name = get_new_bucket()
        client = get_client()
        check_configure_versioning_retry(bucket_name, "Enabled", "Enabled")
        size = 1*5
    ...
    def test_object_copy_versioned_url_encoding(self):
        print(inspect.getsource(CopyObject.test_object_copy_versioned_url_encoding))
        bucket = get_new_bucket_resource()
    ...
    def test_object_copy_versioning_multipart_upload(self):
        print(inspect.getsource(CopyObject.test_object_copy_versioning_multipart_upload))
        bucket_name = get_new_bucket()
        client = get_client()
        check_configure_versioning_retry(bucket_name, "Enabled", "Enabled")
    ...
    def test_copy_object_ifmatch_good(self):
        print(inspect.getsource(CopyObject.test_copy_object_ifmatch_good))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_copy_object_ifmatch_failed(self):
        print(inspect.getsource(CopyObject.test_copy_object_ifmatch_failed))
        bucket_name = get_new_bucket()
        client = get_client()
        client.put_object(Bucket=bucket_name, Key='foo', Body='bar')
...
class Multipart(unittest.TestCase):
    ...
    def test_multipart_resend_first_finishes_last(self):
        print(inspect.getsource(Multipart.test_multipart_resend_first_finishes_last))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_atomic_multipart_upload_write(test):
        print(inspect.getsource(Multipart.test_atomic_multipart_upload_write))
        bucket_name = get_new_bucket()
        client = get_client()
        client.put_object(Bucket=bucket_name, Key='foo', Body='bar')
    ...
    def test_multipart_copy_invalid_range(self):
        print(inspect.getsource(Multipart.test_multipart_copy_invalid_range))
        client = get_client()
        src_key = 'source'
    ...
    def test_multipart_copy_without_range(self):
        print(inspect.getsource(Multipart.test_multipart_copy_without_range))
        client = get_client()
        src_key = 'source'
    ...
    def test_multipart_upload_small(self):
        print(inspect.getsource(Multipart.test_multipart_upload_small))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_multipart_copy_small(self):
        print(inspect.getsource(Multipart.test_multipart_copy_small))
        src_key = 'foo'
    ...
    @attr(major='Multipart')
    @attr(minor='Special Names')
    @attr(resource='object')
    @attr(method='put')
    @attr(operation='check multipart copies with single small part')
    def test_multipart_copy_special_names(self):
        print(inspect.getsource(Multipart.test_multipart_copy_special_names))
    ...
    def test_multipart_upload(self):
        print(inspect.getsource(Multipart.test_multipart_upload))
        bucket_name = get_new_bucket()
        key="mymultipart"
        content_type='text/bla'
        objlen = 30 * 1024 * 1024
    ...
    def test_multipart_copy_versioned(self):
        print(inspect.getsource(Multipart.test_multipart_copy_versioned))
        src_bucket_name = get_new_bucket()
        dest_bucket_name = get_new_bucket()
    ...
    def test_multipart_upload_resend_part(self):
        print(inspect.getsource(Multipart.test_multipart_upload_resend_part))
        bucket_name = get_new_bucket()
        key="mymultipart"
        objlen = 30 * 1024 * 1024
    ...
    def test_multipart_upload_multiple_sizes(self):
        print(inspect.getsource(Multipart.test_multipart_upload_multiple_sizes))
        bucket_name = get_new_bucket()
        key="mymultipart"
        client = get_client()
    ...
    def test_multipart_copy_multiple_sizes(self):
        print(inspect.getsource(Multipart.test_multipart_copy_multiple_sizes))
        src_key = 'foo'
    ...
    def test_multipart_upload_size_too_small(self):
        print(inspect.getsource(Multipart.test_multipart_upload_size_too_small))
        bucket_name = get_new_bucket()
        key="mymultipart"
        client = get_client()
    ...
    def test_multipart_upload_contents(self):
        print(inspect.getsource(Multipart.test_multipart_upload_contents))
        bucket_name = get_new_bucket()
    ...
    def test_multipart_upload_overwrite_existing_object(self):
        print(inspect.getsource(Multipart.test_multipart_upload_overwrite_existing_object))
        bucket_name = get_new_bucket()
        client = get_client()
        key = 'mymultipart'
    ...
    def test_abort_multipart_upload(self):
        print(inspect.getsource(Multipart.test_abort_multipart_upload))
        bucket_name = get_new_bucket()
        key="mymultipart"
        objlen = 10 * 1024 * 1024
        client = get_client()
    ...
    def test_abort_multipart_upload_not_found(self):
        print(inspect.getsource(Multipart.test_abort_multipart_upload_not_found))
        bucket_name = get_new_bucket()
        client = get_client()
        key="mymultipart"
    ...
    def test_list_multipart_upload(self):
        print(inspect.getsource(Multipart.test_list_multipart_upload))
        bucket_name = get_new_bucket()
        client = get_client()
        key="mymultipart"
        mb = 1024 * 1024
    ...
    def test_multipart_upload_missing_part(self):
        print(inspect.getsource(Multipart.test_multipart_upload_missing_part))
        bucket_name = get_new_bucket()
        client = get_client()
        key="mymultipart"
        size = 1
    ...
    def test_multipart_upload_incorrect_etag(self):
        print(inspect.getsource(Multipart.test_multipart_upload_incorrect_etag))
        bucket_name = get_new_bucket()
        client = get_client()
        key="mymultipart"
        size = 1
...
class Cors(unittest.TestCase):
    ...
    def test_set_cors(self):
        print(inspect.getsource(Cors.test_set_cors))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_cors_origin_response(self):
        print(inspect.getsource(Cors.test_cors_origin_response))
        ...
        _cors_request_and_check(requests.put, obj_url, {'Origin': 'foo.suffix', 'Access-Control-Request-Method': 'GET', 'content-length': '0'}, 403, 'foo.suffix', 'GET')
        _cors_request_and_check(requests.put, obj_url, {'Origin': 'foo.suffix', 'Access-Control-Request-Method': 'PUT', 'content-length': '0'}, 403, None, None)

        _cors_request_and_check(requests.put, obj_url, {'Origin': 'foo.suffix', 'Access-Control-Request-Method': 'DELETE', 'content-length': '0'}, 403, None, None)
       ...
       # _cors_request_and_check(requests.options, url, {'Origin': 'bla'}, 400, None, None)
        _cors_request_and_check(requests.options, url, {'Origin': 'foo.suffix'}, 403, None, None)
        _cors_request_and_check(requests.options, url, {'Origin': 'bla'}, 403, None, None)
        _cors_request_and_check(requests.options, obj_url, {'Origin': 'foo.suffix', 'Access-Control-Request-Method': 'GET', 'content-length': '0'}, 200, 'foo.suffix', 'GET')
    ...
    def test_cors_origin_wildcard(self):
        print(inspect.getsource(Cors.test_cors_origin_wildcard))
        bucket_name = _setup_bucket_acl(bucket_acl='public-read')
        client = get_client()
    ...
    def test_cors_header_option(self):
        print(inspect.getsource(Cors.test_cors_header_option))
        bucket_name = _setup_bucket_acl(bucket_acl='public-read')
        client = get_client()
...
class Taggings(unittest.TestCase):
    @attr(major='Taggings')
    @attr(minor='Check')
    @attr(resource='bucket')
    @attr(method='put')
    ...
    def test_set_tagging(self):
        print(inspect.getsource(Taggings.test_set_tagging))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_get_obj_tagging(self):
        print(inspect.getsource(Taggings.test_get_obj_tagging))
        key = 'testputtags'
    ...
    def test_get_obj_head_tagging(self):
        print(inspect.getsource(Taggings.test_get_obj_head_tagging))
        key = 'testputtags'
        bucket_name = _create_key_with_random_content(key)
        client = get_client()
        count = 2
    ...
    def test_put_max_tags(self):
        print(inspect.getsource(Taggings.test_put_max_tags))
        key = 'testputmaxtags'
        bucket_name = _create_key_with_random_content(key)
        client = get_client()
    ...
    def test_put_excess_tags(self):
        print(inspect.getsource(Taggings.test_put_excess_tags))
        key = 'testputmaxtags'
        bucket_name = _create_key_with_random_content(key)
        client = get_client()
    ...
    def test_put_max_kvsize_tags(self):
        print(inspect.getsource(Taggings.test_put_max_kvsize_tags))
    ...
    def test_put_excess_key_tags(self):
        print(inspect.getsource(Taggings.test_put_excess_key_tags))
    ...
    def test_put_excess_val_tags(self):
        print(inspect.getsource(Taggings.test_put_excess_val_tags))
        key = 'testputexcesskeytags'
        bucket_name = _create_key_with_random_content(key)
        client = get_client()
    ...
    def test_put_modify_tags(self):
        print(inspect.getsource(Taggings.test_put_modify_tags))
    ...
    def test_put_delete_tags(self):
        print(inspect.getsource(Taggings.test_put_delete_tags))
        key = 'testputmodifytags'
        bucket_name = _create_key_with_random_content(key)
        client = get_client()
    ...
    def test_post_object_tags_authenticated_request(self):
        print(inspect.getsource(Taggings.test_post_object_tags_authenticated_request))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_put_obj_with_tags(self):
        print(inspect.getsource(Taggings.test_put_obj_with_tags))
        bucket_name = get_new_bucket()
        client = get_client()
        key = 'testtagobj1'
        data = 'A'*100
...
class Atomic(unittest.TestCase):
    ...
    def test_atomic_read_1mb(self):
        print(inspect.getsource(Atomic.test_atomic_read_1mb))
    ...
    def test_atomic_read_4mb(self):
        print(inspect.getsource(Atomic.test_atomic_read_4mb))
    ...
    def test_atomic_read_8mb(self):
        print(inspect.getsource(Atomic.test_atomic_read_8mb))
    ...
    def test_atomic_write_1mb(self):
        print(inspect.getsource(Atomic.test_atomic_write_1mb))
    ...
    def test_atomic_write_4mb(self):
        print(inspect.getsource(Atomic.test_atomic_write_4mb))
    ...
    def test_atomic_write_8mb(self):
        print(inspect.getsource(Atomic.test_atomic_write_8mb))
    ...
    def test_atomic_dual_write_1mb(self):
        print(inspect.getsource(Atomic.test_atomic_dual_write_1mb))
    ...
    def test_atomic_dual_write_4mb(self):
        print(inspect.getsource(Atomic.test_atomic_dual_write_4mb))
    ...
    def test_atomic_dual_write_8mb(self):
        print(inspect.getsource(Atomic.test_atomic_dual_write_8mb))
    ...
    def test_atomic_conditional_write_1mb(self):
        print(inspect.getsource(Atomic.test_atomic_conditional_write_1mb))
        _test_atomic_conditional_write(1024*1024)

class Versioning(unittest.TestCase):
    @attr(major='Versioning')
    @attr(minor='Check')
    @attr(resource='bucket')
    @attr(method='create')
    ...
    def test_versioning_bucket_create_suspend(self):
        print(inspect.getsource(Versioning.test_versioning_bucket_create_suspend))
        bucket_name = get_new_bucket()
    ...
    def test_versioning_obj_create_read_remove(self):
        print(inspect.getsource(Versioning.test_versioning_obj_create_read_remove))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_versioning_obj_create_read_remove_head(self):
        print(inspect.getsource(Versioning.test_versioning_obj_create_read_remove_head))
        bucket_name = get_new_bucket()
    ...
    def test_versioning_obj_plain_null_version_removal(self):
        print(inspect.getsource(Versioning.test_versioning_obj_plain_null_version_removal))
        bucket_name = get_new_bucket()
        check_versioning(bucket_name, None)
    ...
    def test_versioning_obj_plain_null_version_overwrite(self):
        print(inspect.getsource(Versioning.test_versioning_obj_plain_null_version_overwrite))
        bucket_name = get_new_bucket()
        check_versioning(bucket_name, None)
    ...
    def test_versioning_obj_plain_null_version_overwrite_suspended(self):
        print(inspect.getsource(Versioning.test_versioning_obj_plain_null_version_overwrite_suspended))
        bucket_name = get_new_bucket()
        check_versioning(bucket_name, None)
    ...
    def test_versioning_obj_suspend_versions(self):
        print(inspect.getsource(Versioning.test_versioning_obj_suspend_versions))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_versioning_obj_create_versions_remove_all(self):
        print(inspect.getsource(Versioning.test_versioning_obj_create_versions_remove_all))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_versioning_obj_create_versions_remove_special_names(self):
        print(inspect.getsource(Versioning.test_versioning_obj_create_versions_remove_special_names))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_versioning_obj_create_overwrite_multipart(self):
        print(inspect.getsource(Versioning.test_versioning_obj_create_overwrite_multipart))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_versioning_obj_list_marker(self):
        print(inspect.getsource(Versioning.test_versioning_obj_list_marker))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_versioning_copy_obj_version(self):
        print(inspect.getsource(Versioning.test_versioning_copy_obj_version))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_versioning_multi_object_delete(self):
        print(inspect.getsource(Versioning.test_versioning_multi_object_delete))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_versioning_multi_object_delete_with_marker(self):
        print(inspect.getsource(Versioning.test_versioning_multi_object_delete_with_marker))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_versioning_multi_object_delete_with_marker_create(self):
        print(inspect.getsource(Versioning.test_versioning_multi_object_delete_with_marker_create))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_versioned_object_acl(self):
        print(inspect.getsource(Versioning.test_versioned_object_acl))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_versioned_object_acl_no_version_specified(self):
        print(inspect.getsource(Versioning.test_versioned_object_acl_no_version_specified))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_versioned_concurrent_object_create_and_remove(self):
        print(inspect.getsource(Versioning.test_versioned_concurrent_object_create_and_remove))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_versioning_bucket_atomic_upload_return_version_id(self):
        print(inspect.getsource(Versioning.test_versioning_bucket_atomic_upload_return_version_id))
        bucket_name = get_new_bucket()
        client = get_client()
        key = 'bar'
    ...
    def test_versioning_bucket_multipart_upload_return_version_id(self):
        print(inspect.getsource(Versioning.test_versioning_bucket_multipart_upload_return_version_id))
        content_type='text/bla'
        objlen = 30 * 1024 * 1024
...
class Lifecycle(unittest.TestCase):
    ...
    def test_lifecycle_set(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_set))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_lifecycle_get(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_get))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_lifecycle_get_no_id(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_get_no_id))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_lifecycle_expiration_versioning_enabled(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_expiration_versioning_enabled))
        bucket_name = get_new_bucket()
        client = get_client()
        check_configure_versioning_retry(bucket_name, "Enabled", "Enabled")
    ...
    def test_lifecycle_id_too_long(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_id_too_long))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_lifecycle_same_id(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_same_id))
        bucket_name = get_new_bucket()
        client = get_client()
        rules=[{'ID': 'rule1', 'Expiration': {'Days': 1}, 'Prefix': 'test1/', 'Status':'Enabled'},
    ...
    def test_lifecycle_invalid_status(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_invalid_status))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_lifecycle_set_date(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_set_date))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_lifecycle_set_invalid_date(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_set_invalid_date))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    #    print(inspect.getsource(Lifecycle.test_lifecycle_expiration_date))
    ...
    def test_lifecycle_set_noncurrent(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_set_noncurrent))
        bucket_name = _create_objects(keys=['past/foo', 'future/bar'])
        client = get_client()
    ...
    def test_lifecycle_noncur_expiration(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_noncur_expiration))
        bucket_name = get_new_bucket()
        client = get_client()
        check_configure_versioning_retry(bucket_name, "Enabled", "Enabled")
    ...
    def test_lifecycle_set_deletemarker(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_set_deletemarker))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_lifecycle_set_filter(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_set_filter))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_lifecycle_set_empty_filter(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_set_empty_filter))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_lifecycle_deletemarker_expiration(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_deletemarker_expiration))
        bucket_name = get_new_bucket()
        client = get_client()
        check_configure_versioning_retry(bucket_name, "Enabled", "Enabled")
        create_multiple_versions(client, bucket_name, "test1/a", 1)
    ...
    def test_lifecycle_set_multipart(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_set_multipart))
        bucket_name = get_new_bucket()
        client = get_client()
        rules = [
    ...
    def test_lifecycle_multipart_expiration(self):
        print(inspect.getsource(Lifecycle.test_lifecycle_multipart_expiration))
        bucket_name = get_new_bucket()
        client = get_client()
...
class Policy(unittest.TestCase):
    ...
    def test_bucket_policy(self):
        print(inspect.getsource(Policy.test_bucket_policy))
        bucket_name = get_new_bucket()
        client = get_client()
        key = 'asdf'
    ...
    def test_bucketv2_policy(self):
        print(inspect.getsource(Policy.test_bucketv2_policy))
        bucket_name = get_new_bucket()
        client = get_client()
        key = 'asdf'
        client.put_object(Bucket=bucket_name, Key=key, Body='asdf')
    ...
    def test_bucket_policy_acl(self):
        print(inspect.getsource(Policy.test_bucket_policy_acl))
        bucket_name = get_new_bucket()
        client = get_client()
        key = 'asdf'
        client.put_object(Bucket=bucket_name, Key=key, Body='asdf')
    ...
    def test_bucketv2_policy_acl(self):
        print(inspect.getsource(Policy.test_bucketv2_policy_acl))
        bucket_name = get_new_bucket()
        client = get_client()
        key = 'asdf'
        client.put_object(Bucket=bucket_name, Key=key, Body='asdf')
    ...
    def test_get_tags_acl_public(self):
        print(inspect.getsource(Policy.test_get_tags_acl_public))
        key = 'testputtagsacl'
        bucket_name = _create_key_with_random_content(key)
        client = get_client()
    ...
    def test_put_tags_acl_public(self):
        print(inspect.getsource(Policy.test_put_tags_acl_public))
        key = 'testputtagsacl'
        bucket_name = _create_key_with_random_content(key)
        client = get_client()
    ...
    def test_delete_tags_obj_public(self):
        print(inspect.getsource(Policy.test_delete_tags_obj_public))
        key = 'testputtagsacl'
        bucket_name = _create_key_with_random_content(key)
        client = get_client()
    ...
    def test_bucket_policy_get_obj_existing_tag(self):
        print(inspect.getsource(Policy.test_bucket_policy_get_obj_existing_tag))
    ...
    def test_bucket_policy_get_obj_tagging_existing_tag(self):
        print(inspect.getsource(Policy.test_bucket_policy_get_obj_tagging_existing_tag))
        bucket_name = _create_objects(keys=['publictag', 'privatetag', 'invalidtag'])
        client = get_client()
    ...
    def test_bucket_policy_put_obj_tagging_existing_tag(self):
        print(inspect.getsource(Policy.test_bucket_policy_put_obj_tagging_existing_tag))
        bucket_name = _create_objects(keys=['publictag', 'privatetag', 'invalidtag'])
        client = get_client()
    ...
    def test_bucket_policy_put_obj_copy_source(self):
        print(inspect.getsource(Policy.test_bucket_policy_put_obj_copy_source))
    ...
    def test_bucket_policy_put_obj_copy_source_meta(self):
        print(inspect.getsource(Policy.test_bucket_policy_put_obj_copy_source_meta))
    ...
    def test_bucket_policy_put_obj_acl(self):
        print(inspect.getsource(Policy.test_bucket_policy_put_obj_acl))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_bucket_policy_put_obj_grant(self):
        print(inspect.getsource(Policy.test_bucket_policy_put_obj_grant))
        bucket_name = get_new_bucket()
        bucket_name2 = get_new_bucket()
        client = get_client()
    ...
    def test_bucket_policy_get_obj_acl_existing_tag(self):
        print(inspect.getsource(Policy.test_bucket_policy_get_obj_acl_existing_tag))
        bucket_name = _create_objects(keys=['publictag', 'privatetag', 'invalidtag'])
        client = get_client()
    ...
    @attr(assertion='succeeds')
    @attr('policy_status')
    def test_get_publicpolicy_acl_bucket_policy_status(self):
        print(inspect.getsource(Policy.test_get_publicpolicy_acl_bucket_policy_status))
        bucket_name = get_new_bucket()
        client = get_client()
        client = get_client()
    ...
    @attr(assertion='succeeds')
    @attr('policy_status')
    def test_get_nonpublicpolicy_acl_bucket_policy_status(self):
        print(inspect.getsource(Policy.test_get_nonpublicpolicy_acl_bucket_policy_status))
        bucket_name = get_new_bucket()
        client = get_client()
        client = get_client()
...
class Lock(unittest.TestCase):
    ...
    def test_object_lock_put_obj_lock(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_lock))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
    ...
    def test_object_lock_put_obj_lock_invalid_bucket(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_lock_invalid_bucket))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name)
        conf = {'ObjectLockEnabled':'Enabled',
    ...
    def test_object_lock_put_obj_lock_with_days_and_years(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_lock_with_days_and_years))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        conf = {'ObjectLockEnabled':'Enabled',
    ...
    def test_object_lock_put_obj_lock_invalid_days(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_lock_invalid_days))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        conf = {'ObjectLockEnabled':'Enabled',
    ...
    def test_object_lock_put_obj_lock_invalid_years(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_lock_invalid_years))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        conf = {'ObjectLockEnabled':'Enabled',
    ...
    def test_object_lock_put_obj_lock_invalid_status(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_lock_invalid_status))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
    ...
    def test_object_lock_suspend_versioning(self):
        print(inspect.getsource(Lock.test_object_lock_suspend_versioning))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
    ...
    def test_object_lock_get_obj_lock(self):
        print(inspect.getsource(Lock.test_object_lock_get_obj_lock))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        conf = {'ObjectLockEnabled':'Enabled',
    ...
    def test_object_lock_get_obj_lock_invalid_bucket(self):
        print(inspect.getsource(Lock.test_object_lock_get_obj_lock_invalid_bucket))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name)
    ...
    def test_object_lock_put_obj_retention(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_retention))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        key = 'file1'
    ...
    def test_object_lock_put_obj_retention_invalid_bucket(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_retention_invalid_bucket))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name)
        key = 'file1'
    ...
    def test_object_lock_put_obj_retention_invalid_mode(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_retention_invalid_mode))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        key = 'file1'
    ...
    def test_object_lock_get_obj_retention(self):
        print(inspect.getsource(Lock.test_object_lock_get_obj_retention))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        key = 'file1'
    ...
    def test_object_lock_get_obj_retention_invalid_bucket(self):
        print(inspect.getsource(Lock.test_object_lock_get_obj_retention_invalid_bucket))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name)
        key = 'file1'
    ...
    def test_object_lock_put_obj_retention_versionid(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_retention_versionid))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        key = 'file1'
    ...
    def test_object_lock_put_obj_retention_override_default_retention(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_retention_override_default_retention))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        conf = {'ObjectLockEnabled':'Enabled',
    ...
    def test_object_lock_put_obj_retention_increase_period(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_retention_increase_period))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        key = 'file1'
    ...
    def test_object_lock_put_obj_retention_shorten_period(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_retention_shorten_period))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        key = 'file1'
    ...
    def test_object_lock_put_obj_retention_shorten_period_bypass(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_retention_shorten_period_bypass))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        key = 'file1'
    ...
    def test_object_lock_delete_object_with_retention(self):
        print(inspect.getsource(Lock.test_object_lock_delete_object_with_retention))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        key = 'file1'
    ...
    def test_object_lock_put_legal_hold(self):
        print(inspect.getsource(Lock.test_object_lock_put_legal_hold))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        key = 'file1'
    ...
    def test_object_lock_put_legal_hold_invalid_bucket(self):
        print(inspect.getsource(Lock.test_object_lock_put_legal_hold_invalid_bucket))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name)
        key = 'file1'
    ...
    def test_object_lock_put_legal_hold_invalid_status(self):
        print(inspect.getsource(Lock.test_object_lock_put_legal_hold_invalid_status))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        key = 'file1'
    ...
    def test_object_lock_get_legal_hold(self):
        print(inspect.getsource(Lock.test_object_lock_get_legal_hold))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        key = 'file1'
    ...
    def test_object_lock_get_legal_hold_invalid_bucket(self):
        print(inspect.getsource(Lock.test_object_lock_get_legal_hold_invalid_bucket))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name)
        key = 'file1'
    ...
    def test_object_lock_delete_object_with_legal_hold_on(self):
        print(inspect.getsource(Lock.test_object_lock_delete_object_with_legal_hold_on))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        key = 'file1'
    ...
    def test_object_lock_delete_object_with_legal_hold_off(self):
        print(inspect.getsource(Lock.test_object_lock_delete_object_with_legal_hold_off))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        key = 'file1'
    ...
    def test_object_lock_get_obj_metadata(self):
        print(inspect.getsource(Lock.test_object_lock_get_obj_metadata))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        key = 'file1'
    ...
    def test_object_lock_put_obj_lock_invalid_mode(self):
        print(inspect.getsource(Lock.test_object_lock_put_obj_lock_invalid_mode))
        bucket_name = get_new_bucket_name()
        client = get_client()
        client.create_bucket(Bucket=bucket_name, ObjectLockEnabledForBucket=True)
        conf = {'ObjectLockEnabled':'Enabled',
...
class Access(unittest.TestCase):
    ...
    def test_put_public_block(self):
        print(inspect.getsource(Access.test_put_public_block))
    ...
    @attr(assertion='succeeds')
    @attr('policy_status')
    def test_block_public_put_bucket_acls(self):
        print(inspect.getsource(Access.test_block_public_put_bucket_acls))
        #client = get_svc_client(svc='s3control', client_config=Config(s3={'addressing_style': 'path'}))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    @attr(assertion='succeeds')
    @attr('policy_status')
    def test_block_public_object_canned_acls(self):
        print(inspect.getsource(Access.test_block_public_object_canned_acls))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_block_public_policy(self):
        print(inspect.getsource(Access.test_block_public_policy))
        bucket_name = get_new_bucket()
        client = get_client()
    ...
    def test_ignore_public_acls(self):
        print(inspect.getsource(Access.test_ignore_public_acls))
        bucket_name = get_new_bucket()
        client = get_client()
        alt_client = get_alt_client()
...
# class name is 'SSE_C;
# attr name is 'SSE-C'
class SSE_C(unittest.TestCase):
    @attr(major='SSE-C')
    @attr(minor='Metadata')
    @attr(assertion='success')
    @attr('encryption')
    def test_encryption_sse_c_method_head(self):
        print(inspect.getsource(SSE_C.test_encryption_sse_c_method_head))
    ...
    def test_encryption_sse_c_present(self):
        print(inspect.getsource(SSE_C.test_encryption_sse_c_present))
    ...
    def test_encryption_sse_c_other_key(self):
        print(inspect.getsource(SSE_C.test_encryption_sse_c_other_key))
    ...
    def test_encryption_sse_c_invalid_md5(self):
        print(inspect.getsource(SSE_C.test_encryption_sse_c_invalid_md5))
    ...
    def test_encryption_sse_c_no_md5(self):
        print(inspect.getsource(SSE_C.test_encryption_sse_c_no_md5))
    ...
    def test_encryption_sse_c_no_key(self):
        print(inspect.getsource(SSE_C.test_encryption_sse_c_no_key))
...
#   @attr('fails_on_aws') # allow-unordered is a non-standard extension
    def test_encryption_sse_c_multipart_upload(self):
        print(inspect.getsource(SSE_C.test_encryption_sse_c_multipart_upload))
    ...
    def test_encryption_sse_c_multipart_bad_download(self):
        print(inspect.getsource(SSE_C.test_encryption_sse_c_multipart_bad_download))
    ...
    def test_encryption_sse_c_post_object_authenticated_request(self):
        print(inspect.getsource(SSE_C.test_encryption_sse_c_post_object_authenticated_request))
    ...
    def test_encryption_key_no_sse_c(self):
        print(inspect.getsource(SSE_C.test_encryption_key_no_sse_c))
    ...
    def test_encrypted_transfer_1b(self):
        print(inspect.getsource(SSE_C.test_encrypted_transfer_1b))
    ...
    def test_encrypted_transfer_1kb(self):
        print(inspect.getsource(SSE_C.test_encrypted_transfer_1kb))
    ...
    def test_encrypted_transfer_1MB(self):
        print(inspect.getsource(SSE_C.test_encrypted_transfer_1MB))
