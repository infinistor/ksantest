...
public class Grants {
	...
	@Tag("KSAN")
	@Tag("Bucket")
	// [bucket_acl : public-read => bucket_acl : private] 권한을 public-read로 생성한
	...
	@Tag("KSAN")
	@Tag("Bucket")
	// [bucket_acl : public-read-write] 권한을 public-read-write로 생성한 버킷의 acl정보가
	// 올바른지 확인
	...
	@Tag("KSAN")
	@Tag("Bucket")
	// [bucket_acl : authenticated-read] 권한을 authenticated-read로 생성한 버킷의
	// acl정보가 올바른지 확인
	...
	@Tag("KSAN")
	@Tag("Object")
	// [object_acl : public-read => object_acl : private] 권한을 public-read로 생성한
	...
	@Tag("KSAN")
	@Tag("Object")
	// [object_acl : public-read-write] 권한을 public-read-write로 생성한 오브젝트의
	// acl정보가 올바른지 확인
	...
	@Tag("KSAN")
	@Tag("Object")
	// [object_acl : authenticated-read] 권한을 authenticated-read로 생성한 오브젝트의
	// acl정보가 올바른지 확인
	...
	public void test_object_acl_revoke_all() {
		Test.test_object_acl_revoke_all();
	}

	@Test
	@Tag("KSAN")
	@Tag("Access")
	// [bucket_acl:private, object_acl:private] 메인유저가 pirvate권한으로 생성한 버킷과
	...
	@Tag("KSAN")
	@Tag("Access")
	// [bucket_acl:private, object_acl:private, public-read] 메인유저가 pirvate권한으로
	...
	@Tag("KSAN")
	@Tag("Access")
	// [bucket_acl:private, object_acl:private, public-read-write] 메인유저가
	...
	@Tag("KSAN")
	@Tag("Access")
	// [bucket_acl:public-read, object_acl:private] 메인유저가 public-read권한으로 생성한
	...
	@Tag("KSAN")
	@Tag("Access")
	// [bucket_acl:public-read, object_acl:public-read, private] 메인유저가
	...
	@Tag("KSAN")
	@Tag("Access")
	// [bucket_acl:public-read, object_acl:public-read-write, private] 메인유저가
	...
	@Tag("KSAN")
	@Tag("Access")
	// [bucket_acl:public-read-write, object_acl:private] 메인유저가
	...
	@Tag("KSAN")
	@Tag("Access")
	// [bucket_acl:public-read-write, object_acl:public-read, private] 메인유저가
	...
	@Tag("KSAN")
	@Tag("Access")
	// [bucket_acl:public-read-write, object_acl:public-read-write, private]
