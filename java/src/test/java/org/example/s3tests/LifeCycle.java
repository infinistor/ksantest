...
public class LifeCycle extends TestBase {
    ...
    public void test_lifecycle_set_invalid_date()
    {
		...
		var Rules = new ArrayList<Rule>();
		Rules.add(new Rule().withId("rule1").withExpirationDate(new Calendar.Builder().setDate(2017, 9, 27).build().getTime())
				.withFilter(new LifecycleFilter(new LifecyclePrefixPredicate("tset1/")))
				.withStatus(BucketLifecycleConfiguration.ENABLED));
    ...
    public void test_lifecycle_set_noncurrent()
    {
		...
		var Rules = new ArrayList<Rule>();
		Rules.add(new Rule().withId("rule1").withNoncurrentVersionExpirationInDays(2)
				.withFilter(new LifecycleFilter(new LifecyclePrefixPredicate("past/")))
				.withStatus(BucketLifecycleConfiguration.ENABLED));
		Rules.add(new Rule().withId("rule2").withNoncurrentVersionExpirationInDays(3)
    ...
    public void test_lifecycle_deletemarker_expiration()
    {
		...
		var Rules = new ArrayList<Rule>();
		Rules.add(new Rule().withId("rule1").withNoncurrentVersionExpirationInDays(1)
