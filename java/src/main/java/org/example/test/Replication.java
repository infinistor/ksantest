...
public class Replication extends TestBase
{
    ...
    public void test_replication_no_rule()
    {
        ...
        String TargetBucketARN = "arn:aws:s3:test1::" + TargetBucketName;
    ...
    public void test_replication_tagging()
    {
        ...
        Client.setObjectTagging(
                new SetObjectTaggingRequest(SourceBucketName, KeyName2, InputTagSet));
    ...
    public void test_replication_deletemarker_copy()
    {
        ...
        ReplicationDestinationConfig destination1 = new ReplicationDestinationConfig().withBucketARN(
                Target1BucketARN);
        ReplicationDestinationConfig destination2 = new ReplicationDestinationConfig().withBucketARN(
                Target2BucketARN);
        ReplicationRule rule1 = new ReplicationRule().withStatus("Enabled").withDestinationConfig(destination1).withPrefix("");
        ReplicationRule rule2 = new ReplicationRule().withStatus("Enabled").withDestinationConfig(destination2)
                                    .withDeleteMarkerReplication(new DeleteMarkerReplication().withStatus("Enabled")).withPrefix("");
        BucketReplicationConfiguration config = new BucketReplicationConfiguration();
        config.setRoleARN("arn:aws:iam::635518764071:role/awsreplicationtest");
        ...
        var SourceVerions = GetVersions(SourceVersionsResource.getVersionSummaries());
        var SourceDeleteMarkers = GetDeleteMarkers(
                SourceVersionsResource.getVersionSummaries());
        ...
        var Target2DeleteMarkers = GetDeleteMarkers(
                Target2VersionsResource.getVersionSummaries());
